<h1 align="center">📚 VirusTotal Guide</h1>
<h4 align="center">คู่มือตรวจ Hash, IP, URL — สำหรับคนที่เพิ่งเริ่มใช้จนถึงใช้ประจำ</h4>
...
**[VirusTotal](https://www.virustotal.com)** รวม AV Engine กว่า 70 ตัวไว้ที่เดียว — วาง Hash หรือ IP ลงไปก็รู้ได้เลยว่าอันตรายไหม ใช้ฟรีไม่ต้องสมัครสมาชิก (แต่สมัครแล้วเห็นข้อมูลเพิ่ม)
...
## สิ่งที่ต้องจดลง Ticket ทุกครั้ง
